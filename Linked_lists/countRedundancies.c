...
int countRedun(struct digit *start)
{
    int num_of_elements = 0, all_elements = 0, no_duplicates_count = 0, redundancy_count = 0;
    struct digit *node_counter_temp = start;
    struct digit *node_array_temp = start;
    ...
    redundancy_count = all_elements - num_of_elements;
